...
/** @addtogroup GR553xx_int
  * @{
  */

#ifndef __GR553xx_INT_H__
#define __GR553xx_INT_H__
...
{
    __IOM uint32_t DPAD_PE_BUS_0;           /**< DPAD 0-31 Pull Enable Register,                                       Address offset: 0x0000 */
    __IOM uint32_t DPAD_PS_BUS_0;           /**< DPAD 0-31 Pull Select type Register,                                  Address offset: 0x0004 */
    __IOM uint32_t DPAD_IE_BUS_0;           /**< DPAD 0-31 Input Enable Register,                                      Address offset: 0x0008 */
    __IOM uint32_t DPAD_IS_BUS_0;           /**< DPAD 0-31 Input Select type Register,                                 Address offset: 0x000C */
    __IOM uint32_t DPAD_SR_BUS_0;           /**< DPAD 0-31 Slew Rate Register,                                         Address offset: 0x0010 */
    __IOM uint32_t DPAD_DS0_BUS_0;          /**< DPAD 0-31 Drive Strength 0 Register,                                  Address offset: 0x0014 */
    __IOM uint32_t DPAD_DS1_BUS_0;          /**< DPAD 0-31 Drive Strength 1 Register,                                  Address offset: 0x0018 */
    __IOM uint32_t DPAD_POE_BUS_0;          /**< DPAD 0-31 Parametric Output Enable Resistor,                          Address offset: 0x001C */

    __IOM uint32_t DPAD_PE_BUS_1;           /**< DPAD 32-33 Pull Enable Register,                                      Address offset: 0x0020 */
    __IOM uint32_t DPAD_PS_BUS_1;           /**< DPAD 32-33 Pull Select type Register,                                 Address offset: 0x0024 */
    __IOM uint32_t DPAD_IE_BUS_1;           /**< DPAD 32-33 Input Enable Register,                                     Address offset: 0x0028 */
    __IOM uint32_t DPAD_IS_BUS_1;           /**< DPAD 32-33 Input Select type Register,                                Address offset: 0x002C */
    __IOM uint32_t DPAD_SR_BUS_1;           /**< DPAD 32-33 Slew Rate Register,                                        Address offset: 0x0030 */
    __IOM uint32_t DPAD_DS0_BUS_1;          /**< DPAD 32-33 Drive Strength 0 Register,                                 Address offset: 0x0034 */
    __IOM uint32_t DPAD_DS1_BUS_1;          /**< DPAD 32-33 Drive Strength 1 Register,                                 Address offset: 0x0038 */
    __IOM uint32_t DPAD_POE_BUS_1;          /**< DPAD 32-33 Parametric Output Enable Resistor,                         Address offset: 0x003C */

    __IOM uint32_t DPAD_PE_BUS_2;           /**< XQSPI PAD Pull Enable Register,                                       Address offset: 0x0040 */
    __IOM uint32_t DPAD_PS_BUS_2;           /**< XQSPI PAD Pull Select type Register,                                  Address offset: 0x0044 */
    __IOM uint32_t DPAD_IE_BUS_2;           /**< XQSPI PAD Input Enable Register,                                      Address offset: 0x0048 */
    __IOM uint32_t DPAD_IS_BUS_2;           /**< XQSPI PAD Input Select type Register,                                 Address offset: 0x004C */
    __IOM uint32_t DPAD_SR_BUS_2;           /**< XQSPI PAD Slew Rate Register,                                         Address offset: 0x0050 */
    __IOM uint32_t DPAD_DS0_BUS_2;          /**< XQSPI PAD Drive Strength 0 Register,                                  Address offset: 0x0054 */
    __IOM uint32_t DPAD_DS1_BUS_2;          /**< XQSPI PAD Drive Strength 1 Register,                                  Address offset: 0x0058 */
    __IOM uint32_t DPAD_POE_BUS_2;          /**< XQSPI PAD Parametric Output Enable Resistor,                          Address offset: 0x005C */

    __IOM uint32_t DPAD_MUX_CTL_00_07;      /**< Select DPAD mux mode for each PAD,                                    Address offset: 0x0060 */
    __IOM uint32_t DPAD_MUX_CTL_08_15;      /**< Select DPAD mux mode for each PAD,                                    Address offset: 0x0064 */
    __IOM uint32_t DPAD_MUX_CTL_16_23;      /**< Select DPAD mux mode for each PAD,                                    Address offset: 0x0080 */
    __IOM uint32_t DPAD_MUX_CTL_24_31;      /**< Select DPAD mux mode for each PAD,                                    Address offset: 0x0084 */
    __IOM uint32_t DPAD_MUX_CTL_32_39;      /**< Select mux mode for each MSIO B PAD,                                  Address offset: 0x0088 */
    __IOM uint32_t AON_PAD_MUX_CTL;         /**< Select mux mode for each AON PAD,                                     Address offset: 0x008C */
    __IOM uint32_t MSIO_A_PAD_MUX_CTL;      /**< Select mux mode for each MSIO A PAD,                                  Address offset: 0x0090 */
    __IOM uint32_t DPAD_28_29_ANA_ENABLE;   /**< Select DPAD ana enable,                                               Address offset: 0x007C */

    __IOM uint32_t RESERVED1[8];            /**< RESERVED,                                                             Address offset: 0x0080 */
    __IOM uint32_t MCU_SUBSYS_CG_CTRL[3];   /**< Automatic Turn off clock during WFI register ,                        Address offset: 0x00A0 */
    __IOM uint32_t MCU_PERIPH_PCLK_OFF;     /**< Force clock OFF register ,                                            Address offset: 0x00AC */
    __IOM uint32_t MCU_PERIPH_CG_LP_EN;     /**< Low Power feature control register ,                                  Address offset: 0x00B0 */
    __IOM uint32_t MCU_PERIPH_CLK_SLP_OFF;  /**< Turn the peripherals off during WFI/WFE register ,                    Address offset: 0x00B4 */
    __IOM uint32_t SECU_CLK_CTRL;           /**< Security block clock control  register,                               Address offset: 0x00B8 */
    __IOM uint32_t MCU_MISC_CLK;            /**< MCU MISC register,                                                    Address offset: 0x00BC */
    __IOM uint32_t HFOSC_CLK_EN;            /**< PLL HFOSC CLK EN register,                                            Address offset: 0x00C0 */
    __IOM uint32_t CLK_FORCE_ON;            /**< Force MCC clocks on for debug purpose,                                Address offset: 0x00C4 */
} mcu_ret_regs_t;
...
typedef struct _aon_ctl_regs
{
    ...
    __IOM uint32_t RESERVED6[3];              /**< RESERVED,                                                             Address offset: 0x01C8 */
    __IOM uint32_t MSIO_A_PAD_CFG0;           /**< MISOA PAD Configuration 0 Register,                                   Address offset: 0x01D4 */
    __IOM uint32_t MSIO_A_PAD_CFG1;           /**< MISOA PAD Configuration 1 Register,                                   Address offset: 0x01D8 */
    __IOM uint32_t MSIO_A_PAD_CFG2;           /**< MISOA PAD Configuration 2 Register,                                   Address offset: 0x01DC */
    __IOM uint32_t MSIO_PAD_MCU_OVR;          /**< MISO PAD OVR Register,                                                  Address offset: 0x01E0 */
    __IOM uint32_t AON_PAD_CTRL0;             /**< AON PAD control 0 Register,                                           Address offset: 0x01E4 */
    __IOM uint32_t AON_PAD_CTRL1;             /**< AON PAD control 1 Register,                                           Address offset: 0x01E8 */
    __IOM uint32_t AON_PAD_CTRL2;             /**< AON PAD control 2 Register,                                           Address offset: 0x01EC */
    ...
    __IOM uint32_t MEM_BOND_OPT;              /**< SRAM bonding option Register, Unvisible for user.                     Address offset: 0x0388 */
} aon_ctl_regs_t;
...
typedef struct _aon_pmu_regs
{
    ...
    __IOM uint32_t RESERVED1[9];              /**< RESERVED,                                                             Address offset: 0x0864 */
    ...
    __IOM uint32_t PMU_CORE_LDO_VREF;             /**< PMU_DCDC_VREF,                                                    Address offset: 0x0898 */
    __IOM uint32_t PMU_DCDC_VREF;             /**< PMU_DCDC_VREF,                                                        Address offset: 0x089C */
    __IOM uint32_t RESERVED3[8];              /**< RESERVED,                                                             Address offset: 0x08A0 */
...
{
    __IOM uint32_t MSIO_A_PAD_CFG0;           /**< MISO PAD Configuration 0 Register,                                    Address offset: 0x01D4 */
    __IOM uint32_t MSIO_A_PAD_CFG1;           /**< MISO PAD Configuration 1 Register,                                    Address offset: 0x01D8 */
    __IOM uint32_t MSIO_A_PAD_CFG2;           /**< MISO PAD Configuration 2 Register,                                    Address offset: 0x01DC */
...
* @{
*/
#define AON_IO_BASE             ((uint32_t)0x4000A1E4UL)
#define AON_MEM_BASE            ((uint32_t)0x4000A480UL)
#define AON_MSIO_BASE           ((uint32_t)0x4000A1D4UL)
...
#define AON_PMU_RF_REG_0_CTRL_RET_Pos                           (10U)
#define AON_PMU_RF_REG_0_CTRL_RET_Len                           (3U)
#define AON_PMU_RF_REG_0_CTRL_RET_Msk                           (0x7U << AON_PMU_RF_REG_0_CTRL_RET_Pos)
...
#define AON_PMU_RF_REG_0_RTC_EN_GM_Pos                          (6U)
#define AON_PMU_RF_REG_0_RTC_EN_GM_Len                          (1U)
#define AON_PMU_RF_REG_0_RTC_EN_GM_Msk                          (0x3U << AON_PMU_RF_REG_0_RTC_EN_GM_Pos)
#define AON_PMU_RF_REG_0_RTC_EN_GM                              AON_PMU_RF_REG_0_RTC_EN_GM_Msk
#define AON_PMU_RF_REG_0_RTC_DIS_GM                             (0x0U << AON_PMU_RF_REG_0_RTC_EN_GM_Pos)
...
#define AON_PMU_RF_REG_0_RNG_CLK_BUMP_Pos                       (15U)
#define AON_PMU_RF_REG_0_RNG_CLK_BUMP_Len                       (1U)
#define AON_PMU_RF_REG_0_RNG_CLK_BUMP_Msk                       (0x1U <<  AON_PMU_RF_REG_0_RNG_CLK_BUMP_Pos)
#define AON_PMU_RF_REG_0_RNG_CLK_BUMP                           AON_PMU_RF_REG_0_RNG_CLK_BUMP_Msk

#define AON_PMU_RF_REG_0_RNG_FREQ_CONT_Pos                      (13U)
...
#define AON_PMU_RF_REG_1_TON_STARTUP_Pos                        (24U)
#define AON_PMU_RF_REG_1_TON_STARTUP_Len                        (1U)
#define AON_PMU_RF_REG_1_TON_STARTUP_Msk                        (0x01U << AON_PMU_RF_REG_1_TON_STARTUP_Pos)
#define AON_PMU_RF_REG_1_TON_STARTUP                            AON_PMU_RF_REG_1_TON_STARTUP_Msk

#define AON_PMU_RF_REG_1_EN_INJ_Pos                             (14U)
#define AON_PMU_RF_REG_1_EN_INJ_Len                             (1U)
#define AON_PMU_RF_REG_1_EN_INJ_Msk                             (0x01U << AON_PMU_RF_REG_1_EN_INJ_Pos)
#define AON_PMU_RF_REG_1_EN_INJ                                 AON_PMU_RF_REG_1_EN_INJ_Msk

#define AON_PMU_RF_REG_1_DCDC_PWR_SRC_Pos                       (12U)
#define AON_PMU_RF_REG_1_DCDC_PWR_SRC_Len                       (1U)
#define AON_PMU_RF_REG_1_DCDC_PWR_SRC_Msk                       (0x01U << AON_PMU_RF_REG_1_DCDC_PWR_SRC_Pos)
...
#define AON_PMU_RF_REG_2_EFUSE_LDO_REF_Pos                      (13U)
#define AON_PMU_RF_REG_2_EFUSE_LDO_REF_Len                      (3U)
#define AON_PMU_RF_REG_2_EFUSE_LDO_REF_Msk                      (0x7U << AON_PMU_RF_REG_2_EFUSE_LDO_REF_Pos)
#define AON_PMU_RF_REG_2_EFUSE_LDO_REF                          AON_PMU_RF_REG_2_EFUSE_LDO_REF_Msk
...
#define AON_PMU_RF_REG_2_EFUSE_LDO_BYPASS_Pos                   (9U)
#define AON_PMU_RF_REG_2_EFUSE_LDO_BYPASS_Len                   (1U)
#define AON_PMU_RF_REG_2_EFUSE_LDO_BYPASS_Msk                   (0x1U << AON_PMU_RF_REG_2_EFUSE_LDO_BYPASS_Pos)
#define AON_PMU_RF_REG_2_EFUSE_LDO_BYPASS                       AON_PMU_RF_REG_2_EFUSE_LDO_BYPASS_Msk
...
#define AON_PMU_RF_REG_3_BOD_STATIC_LV_Pos                      (5U)
...
#define AON_PMU_RF_REG_3_BOD_LVL_CTRL_LV_Len                    (3U)
#define AON_PMU_RF_REG_3_BOD_LVL_CTRL_LV_Msk                    (0x7U <<  AON_PMU_RF_REG_3_BOD_LVL_CTRL_LV_Pos)
...
#define AON_PMU_RF_REG_4_SHORT_AON_DIGCORE_Pos                  (23U)
#define AON_PMU_RF_REG_4_SHORT_AON_DIGCORE_Len                  (1U)
#define AON_PMU_RF_REG_4_SHORT_AON_DIGCORE_Msk                  (0x01U << AON_PMU_RF_REG_4_SHORT_AON_DIGCORE_Pos)
#define AON_PMU_RF_REG_4_SHORT_AON_DIGCORE                      AON_PMU_RF_REG_4_SHORT_AON_DIGCORE_Msk
...
#define AON_PMU_RF_REG_4_DIG_LDO_REG1_Pos                       (16U)
#define AON_PMU_RF_REG_4_DIG_LDO_REG1_Len                       (8U)
#define AON_PMU_RF_REG_4_DIG_LDO_REG1_Msk                       (0xFFU << AON_PMU_RF_REG_4_DIG_LDO_REG1_Pos)
...
#define AON_PMU_RF_REG_4_CLK_PERIOD_Pos                         (11U)
#define AON_PMU_RF_REG_4_CLK_PERIOD_Len                         (5U)
#define AON_PMU_RF_REG_4_CLK_PERIOD_Msk                         (0x1F << AON_PMU_RF_REG_4_CLK_PERIOD_Pos)
...
#define AON_PMU_RF_REG_4_CORE_VO_SEL_Pos                        (18U)
#define AON_PMU_RF_REG_4_CORE_VO_SEL_Len                        (2U)
#define AON_PMU_RF_REG_4_CORE_VO_SEL_Msk                        (0x3U << AON_PMU_RF_REG_4_CORE_VO_SEL_Pos)
#define AON_PMU_RF_REG_4_CORE_VO_SEL                            AON_PMU_RF_REG_4_CORE_VO_SEL_Msk

#define AON_PMU_RF_REG_4_BG_EN_Pos                              (7U)
#define AON_PMU_RF_REG_4_BG_EN_Len                              (1U)
#define AON_PMU_RF_REG_4_BG_EN_Msk                              (0x1U << AON_PMU_RF_REG_4_BG_EN_Pos)
#define AON_PMU_RF_REG_4_BG_EN                                   AON_PMU_RF_REG_4_BG_EN_Msk
...
#define AON_PMU_RC_RTC_REG0_RTC_CGM_MODE_Pos                    (22U)
#define AON_PMU_RC_RTC_REG0_RTC_CGM_MODE_Len                    (1U)
#define AON_PMU_RC_RTC_REG0_RTC_CGM_MODE_Msk                    (0x1UL << AON_PMU_RC_RTC_REG0_RTC_CGM_MODE_Pos)
#define AON_PMU_RC_RTC_REG0_RTC_CGM_MODE                        AON_PMU_RC_RTC_REG0_RTC_CGM_MODE_Msk

#define AON_PMU_RC_RTC_REG0_RTC_EN_Pos                          (23U)
#define AON_PMU_RC_RTC_REG0_RTC_EN_Len                          (1U)
#define AON_PMU_RC_RTC_REG0_RTC_EN_Msk                          (0x1UL << AON_PMU_RC_RTC_REG0_RTC_EN_Pos)
#define AON_PMU_RC_RTC_REG0_RTC_EN                              AON_PMU_RC_RTC_REG0_RTC_EN_Msk
...
#define AON_PMU_FS_REG_0_DCDC_EN_Pos                        (8U)
#define AON_PMU_FS_REG_0_DCDC_EN_Len                        (1U)
#define AON_PMU_FS_REG_0_DCDC_EN_Msk                        (0x1UL << AON_PMU_FS_REG_0_DCDC_EN_Pos)
#define AON_PMU_FS_REG_0_DCDC_EN                            AON_PMU_FS_REG_0_DCDC_EN_Msk

#define AON_PMU_FS_REG_0_SYSLDO_EN_Pos                      (9U)
#define AON_PMU_FS_REG_0_SYSLDO_EN_Len                      (1U)
#define AON_PMU_FS_REG_0_SYSLDO_EN_Msk                      (0x1UL << AON_PMU_FS_REG_0_SYSLDO_EN_Pos)
#define AON_PMU_FS_REG_0_SYSLDO_EN                          AON_PMU_FS_REG_0_SYSLDO_EN_Msk

#define AON_PMU_FS_REG_0_SYSLDO_V_Pos                       (10U)
#define AON_PMU_FS_REG_0_SYSLDO_V_Len                       (4U)
#define AON_PMU_FS_REG_0_SYSLDO_V_Msk                       (0xFUL << AON_PMU_FS_REG_0_SYSLDO_V_Pos)
#define AON_PMU_FS_REG_0_SYSLDO_V                           AON_PMU_FS_REG_0_SYSLDO_V_Msk
...
#define AON_PMU_ADVS_DCDC_EN_VTBIAS_Pos                      (6U)
...
#define AON_PMU_ADVS_DCDC_VTBIAS_CTRL_LIMIT_2_0_Len          (3U)
#define AON_PMU_ADVS_DCDC_VTBIAS_CTRL_LIMIT_2_0_Msk          (0x7UL << AON_PMU_ADVS_DCDC_VTBIAS_CTRL_LIMIT_2_0_Pos)
...
#define AON_PMU_ADVS_DIGCORE_EN_VTBIAS_Pos                   (6U)
...
#define AON_PMU_ADVS_DIGCORE_VTBIAS_CTRL_LIMIT_2_0_Len       (3U)
#define AON_PMU_ADVS_DIGCORE_VTBIAS_CTRL_LIMIT_2_0_Msk       (0x7UL << AON_PMU_ADVS_DIGCORE_VTBIAS_CTRL_LIMIT_2_0_Pos)
...
/*******************  Bit definition for AON_PMU_LPD_CFG register  *******************/
#define AON_PMU_LPD_CFG_VAON_ACTIVE_Pos                      (0U)
#define AON_PMU_LPD_CFG_VAON_ACTIVE_Len                      (3U)
#define AON_PMU_LPD_CFG_VAON_ACTIVE_Msk                      (0x7UL << AON_PMU_LPD_CFG_VAON_ACTIVE_Pos)
#define AON_PMU_LPD_CFG_VAON_ACTIVE                          AON_PMU_LPD_CFG_VAON_ACTIVE_Msk

#define AON_PMU_LPD_CFG_VAON_SLEEP_Pos                       (4U)
#define AON_PMU_LPD_CFG_VAON_SLEEP_Len                       (3U)
#define AON_PMU_LPD_CFG_VAON_SLEEP_Msk                       (0x7UL << AON_PMU_LPD_CFG_VAON_SLEEP_Pos)
#define AON_PMU_LPD_CFG_VAON_SLEEP                           AON_PMU_LPD_CFG_VAON_SLEEP_Msk

/*******************  Bit definition for AON_PMU_PMU_TON_CFG register  *******************/
#define AON_PMU_TON_CFG_CTL_ON_VAL_Pos                      (0U)
#define AON_PMU_TON_CFG_CTL_ON_VAL_Len                      (4U)
#define AON_PMU_TON_CFG_CTL_ON_VAL_Msk                      (0xFUL << AON_PMU_TON_CFG_CTL_ON_VAL_Pos)
#define AON_PMU_TON_CFG_CTL_ON_VAL                          AON_PMU_TON_CFG_CTL_ON_VAL_Msk

#define AON_PMU_TON_CFG_CTL_OFF_VAL_Pos                     (8U)
#define AON_PMU_TON_CFG_CTL_OFF_VAL_Len                     (4U)
#define AON_PMU_TON_CFG_CTL_OFF_VAL_Msk                     (0xFUL << AON_PMU_TON_CFG_CTL_OFF_VAL_Pos)
#define AON_PMU_TON_CFG_CTL_OFF_VAL                         AON_PMU_TON_CFG_CTL_OFF_VAL_Msk

/*******************  Bit definition for PMU_CORE_LDO_VREF register  **********/
#define AON_PMU_CORE_LDO_VREF_REG_SEL_Pos                   (0U)
#define AON_PMU_CORE_LDO_VREF_REG_SEL_Len                   (1U)
#define AON_PMU_CORE_LDO_VREF_REG_SEL_Msk                   (0x1U << AON_PMU_CORE_LDO_VREF_REG_SEL_Pos)
#define AON_PMU_CORE_LDO_VREF_REG_SEL                       AON_PMU_CORE_LDO_VREF_REG_SEL_Msk

#define AON_PMU_CORE_LDO_VREF_Pos                           (8U)
#define AON_PMU_CORE_LDO_VREF_Len                           (5U)
#define AON_PMU_CORE_LDO_VREF_Msk                           (0x1FU << AON_PMU_CORE_LDO_VREF_Pos)
#define AON_PMU_CORE_LDO_VREF                               AON_PMU_CORE_LDO_VREF_Msk

/*******************  Bit definition for PMU_DCDC_VREF register  **********/
#define AON_PMU_DCDC_VREF_REG_VAL_Pos                       (0U)
#define AON_PMU_DCDC_VREF_REG_VAL_Len                       (5U)
#define AON_PMU_DCDC_VREF_REG_VAL_Msk                       (0x1FU << AON_PMU_DCDC_VREF_REG_VAL_Pos)
#define AON_PMU_DCDC_VREF_REG_VAL                           AON_PMU_DCDC_VREF_REG_VAL_Msk
...
#define AON_PWR_A_TIMING_CTRL4_XO_BIAS_SWITCH_Len           (9U)
#define AON_PWR_A_TIMING_CTRL4_XO_BIAS_SWITCH_Msk           (0x1FFUL << AON_PWR_A_TIMING_CTRL4_XO_BIAS_SWITCH_Pos)
...
#define AON_IO_AON_PAD_OUT_VAL_POS                    (0U)
#define AON_IO_AON_PAD_OUT_VAL_Len                    (8U)
#define AON_IO_AON_PAD_OUT_VAL_Msk                    (0xFFUL << AON_IO_AON_PAD_OUT_VAL_POS)
#define AON_IO_AON_PAD_OUT_VAL                        AON_IO_AON_PAD_OUT_VAL_Msk

#define AON_IO_AON_PAD_OE_POS                         (8U)
#define AON_IO_AON_PAD_OE_Len                         (8U)
#define AON_IO_AON_PAD_OE_Msk                         (0xFFUL << AON_IO_AON_PAD_OE_POS)
#define AON_IO_AON_PAD_OE                             AON_IO_AON_PAD_OE_Msk

#define AON_IO_AON_PAD_IE_POS                         (16U)
#define AON_IO_AON_PAD_IE_Len                         (8U)
#define AON_IO_AON_PAD_IE_Msk                         (0xFFUL << AON_IO_AON_PAD_IE_POS)
#define AON_IO_AON_PAD_IE                             AON_IO_AON_PAD_IE_Msk

#define AON_IO_AON_PAD_IN_VAL_POS                     (24U)
#define AON_IO_AON_PAD_IN_VAL_Len                     (8U)
#define AON_IO_AON_PAD_IN_VAL_Msk                     (0xFFUL << AON_IO_AON_PAD_IN_VAL_POS)
#define AON_IO_AON_PAD_IN_VAL                         AON_IO_AON_PAD_IN_VAL_Msk

/*******************  Bit definition for AON_IO_AON_PAD_CTRL1 register  *******************/

#define AON_IO_AON_PAD_PE_POS                         (0U)
#define AON_IO_AON_PAD_PE_Len                         (8U)
#define AON_IO_AON_PAD_PE_Msk                         (0xFFUL << AON_IO_AON_PAD_PE_POS)
#define AON_IO_AON_PAD_PE                             AON_IO_AON_PAD_PE_Msk

#define AON_IO_AON_PAD_PS_POS                         (8U)
#define AON_IO_AON_PAD_PS_Len                         (8U)
#define AON_IO_AON_PAD_PS_Msk                         (0xFFUL << AON_IO_AON_PAD_PS_POS)
#define AON_IO_AON_PAD_PS                             AON_IO_AON_PAD_PS_Msk

#define AON_IO_AON_PAD_IS_POS                         (16U)
#define AON_IO_AON_PAD_IS_Len                         (8U)
#define AON_IO_AON_PAD_IS_Msk                         (0xFFUL << AON_IO_AON_PAD_IS_POS)
#define AON_IO_AON_PAD_IS                             AON_IO_AON_PAD_IS_Msk

#define AON_IO_AON_PAD_SR_POS                         (24U)
#define AON_IO_AON_PAD_SR_Len                         (8U)
#define AON_IO_AON_PAD_SR_Msk                         (0xFFUL << AON_IO_AON_PAD_SR_POS)
#define AON_IO_AON_PAD_SR                             AON_IO_AON_PAD_SR_Msk

/*******************  Bit definition for AON_IO_AON_PAD_CTRL2 register  *******************/
#define AON_IO_AON_PAD_DS0_POS                         (0U)
#define AON_IO_AON_PAD_DS0_Len                         (8U)
#define AON_IO_AON_PAD_DS0_Msk                         (0xFFUL << AON_IO_AON_PAD_DS0_POS)
#define AON_IO_AON_PAD_DS0                             AON_IO_AON_PAD_DS0_Msk

#define AON_IO_AON_PAD_DS1_POS                         (8U)
#define AON_IO_AON_PAD_DS1_Len                         (8U)
#define AON_IO_AON_PAD_DS1_Msk                         (0xFFUL << AON_IO_AON_PAD_DS1_POS)
#define AON_IO_AON_PAD_DS1                             AON_IO_AON_PAD_DS1_Msk

#define AON_IO_AON_PAD_POE_POS                        (16U)
#define AON_IO_AON_PAD_POE_Len                        (8U)
#define AON_IO_AON_PAD_POE_Msk                        (0xFFUL << AON_IO_AON_PAD_POE_POS)
#define AON_IO_AON_PAD_POE_VAL                         AON_IO_AON_PAD_POE_Msk
...
#define AON_IO_AON_MCU_OVR                                  AON_IO_AON_MCU_OVR_OVR_Msk
...
#define AON_MSIO_A_PAD_OUT_VAL_POS                         (0U)
#define AON_MSIO_A_PAD_OUT_VAL_Len                         (8U)
#define AON_MSIO_A_PAD_OUT_VAL_Msk                         (0xFFUL << AON_MSIO_A_PAD_OUT_VAL_POS)
#define AON_MSIO_A_PAD_OUT_VAL                             AON_MSIO_A_PAD_OUT_VAL_Msk

#define AON_MSIO_A_PAD_OE_POS                              (8U)
#define AON_MSIO_A_PAD_OE_Len                              (8U)
#define AON_MSIO_A_PAD_OE_Msk                              (0xFFUL << AON_MSIO_A_PAD_OE_POS)
#define AON_MSIO_A_PAD_OE                                  AON_MSIO_A_PAD_OE_Msk

#define AON_MSIO_A_PAD_IE_POS                              (16U)
#define AON_MSIO_A_PAD_IE_Len                              (8U)
#define AON_MSIO_A_PAD_IE_Msk                              (0xFFUL << AON_MSIO_A_PAD_IE_POS)
#define AON_MSIO_A_PAD_IE                                  AON_MSIO_A_PAD_IE_Msk

#define AON_MSIO_A_PAD_IN_VAL_POS                          (24U)
#define AON_MSIO_A_PAD_IN_VAL_Len                          (8U)
#define AON_MSIO_A_PAD_IN_VAL_Msk                          (0xFFUL << AON_MSIO_A_PAD_IN_VAL_POS)
#define AON_MSIO_A_PAD_IN_VAL                              AON_MSIO_A_PAD_IN_VAL_Msk



/*******************  Bit definition for AON_MSIO_A_PAD_CFG1 register  *******************/
#define AON_MSIO_A_PAD_PE_POS                              (0U)
#define AON_MSIO_A_PAD_PE_Len                              (8U)
#define AON_MSIO_A_PAD_PE_Msk                              (0xFFUL << AON_MSIO_A_PAD_PE_POS)
#define AON_MSIO_A_PAD_PE                                   AON_MSIO_A_PAD_PE_Msk

#define AON_MSIO_A_PAD_PS_POS                              (8U)
#define AON_MSIO_A_PAD_PS_Len                              (8U)
#define AON_MSIO_A_PAD_PS_Msk                              (0xFFUL << AON_MSIO_A_PAD_PS_POS)
#define AON_MSIO_A_PAD_PS                                  AON_MSIO_A_PAD_PS_Msk

#define AON_MSIO_A_PAD_IS_POS                              (16U)
#define AON_MSIO_A_PAD_IS_Len                              (8U)
#define AON_MSIO_A_PAD_IS_Msk                              (0xFFUL << AON_MSIO_A_PAD_IS_POS)
#define AON_MSIO_A_PAD_IS                                  AON_MSIO_A_PAD_IS_Msk

#define AON_MSIO_A_PAD_SR_POS                              (24U)
#define AON_MSIO_A_PAD_SR_Len                              (8U)
#define AON_MSIO_A_PAD_SR_Msk                              (0xFFUL << AON_MSIO_A_PAD_SR_POS)
#define AON_MSIO_A_PAD_SR                                  AON_MSIO_A_PAD_SR_Msk
/*******************  Bit definition for AON_MSIO_A_PAD_CFG2 register  *******************/
#define AON_MSIO_A_PAD_DS0_POS                             (0U)
#define AON_MSIO_A_PAD_DS0_Len                             (8U)
#define AON_MSIO_A_PAD_DS0_Msk                             (0xFFUL << AON_MSIO_A_PAD_DS0_POS)
#define AON_MSIO_A_PAD_DS0                                 AON_MSIO_A_PAD_CFG3_DS0_Msk

#define AON_MSIO_A_PAD_DS1_POS                             (8U)
#define AON_MSIO_A_PAD_DS1_Len                             (8U)
#define AON_MSIO_A_PAD_DS1_Msk                             (0xFFUL << AON_MSIO_A_PAD_DS1_POS)
#define AON_MSIO_A_PAD_DS1                                 AON_MSIO_A_PAD_DS1_Msk

#define AON_MSIO_A_PAD_POE_POS                             (16U)
#define AON_MSIO_A_PAD_POE_Len                             (8U)
#define AON_MSIO_A_PAD_POE_Msk                             (0xFFUL << AON_MSIO_A_PAD_POE_POS)
#define AON_MSIO_A_PAD_POE                                 AON_MSIO_A_PAD_POE_Msk

#define AON_MSIO_A_PAD_AE_POS                              (24U)
#define AON_MSIO_A_PAD_AE_Len                              (8U)
#define AON_MSIO_A_PAD_AE_Msk                              (0xFFUL << AON_MSIO_A_PAD_AE_POS)
#define AON_MSIO_A_PAD_AE                                  AON_MSIO_A_PAD_AE_Msk
...
#define DDVS_RINGO_CNT_01_RINGO_1_CNT_POS                    (0U)
#define DDVS_RINGO_CNT_01_RINGO_1_CNT_Len                    (16U)
#define DDVS_RINGO_CNT_01_RINGO_1_CNT_Msk                    (0xFFFFUL << DDVS_RINGO_CNT_01_RINGO_1_CNT_POS)
#define DDVS_RINGO_CNT_01_RINGO_1_CNT                        DDVS_RINGO_CNT_01_RINGO_1_CNT_Msk

#define DDVS_RINGO_CNT_01_RINGO_0_CNT_POS                    (16U)
#define DDVS_RINGO_CNT_01_RINGO_0_CNT_Len                    (16U)
#define DDVS_RINGO_CNT_01_RINGO_0_CNT_Msk                    (0xFFFFUL << DDVS_RINGO_CNT_01_RINGO_0_CNT_POS)
#define DDVS_RINGO_CNT_01_RINGO_0_CNT                        DDVS_RINGO_CNT_01_RINGO_0_CNT_Msk

/*******************  Bit definition for DDVS_RINGO_CNT_23 register  *************/
#define DDVS_RINGO_CNT_23_RINGO_3_CNT_POS                    (0U)
#define DDVS_RINGO_CNT_23_RINGO_3_CNT_Len                    (16U)
#define DDVS_RINGO_CNT_23_RINGO_3_CNT_Msk                    (0xFFFFUL << DDVS_RINGO_CNT_23_RINGO_3_CNT_POS)
#define DDVS_RINGO_CNT_23_RINGO_3_CNT                        DDVS_RINGO_CNT_23_RINGO_3_CNT_Msk

#define DDVS_RINGO_CNT_23_RINGO_2_CNT_POS                    (16U)
#define DDVS_RINGO_CNT_23_RINGO_2_CNT_Len                    (16U)
#define DDVS_RINGO_CNT_23_RINGO_2_CNT_Msk                    (0xFFFFUL << DDVS_RINGO_CNT_23_RINGO_2_CNT_POS)
...
#define MCU_PAD_DPAD_IE_Len                                 (31U)
#define MCU_PAD_DPAD_IE_Msk                                 (0xFFFFFFFFUL << MCU_PAD_DPAD_IE_POS)
#define MCU_PAD_DPAD_IE                                     MCU_PAD_DPAD_IE_Msk

/*******************  Bit definition for DPAD_PE_BUS register  *****************/
#define MCU_PAD_DPAD_PE_POS                                 (0U)
#define MCU_PAD_DPAD_PE_Len                                 (31U)
#define MCU_PAD_DPAD_PE_Msk                                 (0xFFFFFFFFUL << MCU_PAD_DPAD_PE_POS)
#define MCU_PAD_DPAD_PE                                     MCU_PAD_DPAD_PE_Msk

/*******************  Bit definition for DPAD_PS_BUS register  *****************/
#define MCU_PAD_DPAD_PS_POS                                 (0U)
#define MCU_PAD_DPAD_PS_Len                                 (31U)
#define MCU_PAD_DPAD_PS_Msk                                 (0xFFFFFFFFUL << MCU_PAD_DPAD_PS_POS)
#define MCU_PAD_DPAD_PS                                     MCU_PAD_DPAD_PS_Msk

/*******************  Bit definition for DPAD_IS_BUS register  *****************/
#define MCU_PAD_DPAD_IS_POS                                 (0U)
#define MCU_PAD_DPAD_IS_Len                                 (31U)
#define MCU_PAD_DPAD_IS_Msk                                 (0xFFFFFFFFUL << MCU_PAD_DPAD_IS_POS)
...
#define MCU_PAD_DPAD_SR_Len                                 (31U)
#define MCU_PAD_DPAD_SR_Msk                                 (0xFFFFFFFFUL << MCU_PAD_DPAD_SR_POS)
#define MCU_PAD_DPAD_SR                                     MCU_PAD_DPAD_SR_Msk

/*******************  Bit definition for DPAD_DS0_BUS register  *****************/
#define MCU_PAD_DPAD_DS0_POS                                 (0U)
#define MCU_PAD_DPAD_DS0_Len                                 (31U)
#define MCU_PAD_DPAD_DS0_Msk                                 (0xFFFFFFFFUL << MCU_PAD_DPAD_DS0_POS)
#define MCU_PAD_DPAD_DS0                                     MCU_PAD_DPAD_DS0_Msk

/*******************  Bit definition for DPAD_DS1_BUS register  *****************/
#define MCU_PAD_DPAD_DS1_POS                                 (0U)
#define MCU_PAD_DPAD_DS1_Len                                 (31U)
#define MCU_PAD_DPAD_DS1_Msk                                 (0xFFFFFFFFUL << MCU_PAD_DPAD_DS1_POS)
#define MCU_PAD_DPAD_DS1                                     MCU_PAD_DPAD_DS1_Msk

/*******************  Bit definition for DPAD_DS1_POE register  *****************/
#define MCU_PAD_DPAD_POE_POS                                 (0U)
#define MCU_PAD_DPAD_POE_Len                                 (31U)
#define MCU_PAD_DPAD_POE_Msk                                 (0xFFFFFFFFUL << MCU_PAD_DPAD_POE_POS)
#define MCU_PAD_DPAD_POE                                     MCU_PAD_DPAD_POE_Msk


/*******************  Bit definition for DPAD_MISC PE\PS\IE\IS\SR\DS0\DS1\POE register  *****************/
#define MCU_PAD_XQSPI_CLK_Pos                     (16U)
#define MCU_PAD_XQSPI_CLK_Len                     (1U)
#define MCU_PAD_XQSPI_CLK_Msk                     (0x1U << MCU_PAD_XQSPI_CLK_Pos)
#define MCU_PAD_XQSPI_CLK                         MCU_PAD_XQSPI_CLK_Msk

#define MCU_PAD_XQSPI_CS_Pos                      (17U)
#define MCU_PAD_XQSPI_CS_Len                      (1U)
#define MCU_PAD_XQSPI_CS_Msk                      (0x1U << MCU_PAD_XQSPI_CS_Pos)
#define MCU_PAD_XQSPI_CS                          MCU_PAD_XQSPI_CS_Msk

#define MCU_PAD_XQSPI_IO_Pos                      (18U)
#define MCU_PAD_XQSPI_IO_Len                      (4U)
#define MCU_PAD_XQSPI_IO_Msk                      (0xFU << MCU_PAD_XQSPI_IO_Pos)
#define MCU_PAD_XQSPI_IO                          MCU_PAD_XQSPI_IO_Msk

#define MCU_PAD_XQSPI_IO0_Pos                     (18U)
#define MCU_PAD_XQSPI_IO0_Len                     (1U)
#define MCU_PAD_XQSPI_IO0_Msk                     (0x1U << MCU_PAD_XQSPI_IO0_Pos)
#define MCU_PAD_XQSPI_IO0                         MCU_PAD_XQSPI_IO0_Msk

#define MCU_PAD_XQSPI_IO1_Pos                     (19U)
#define MCU_PAD_XQSPI_IO1_Len                     (1U)
#define MCU_PAD_XQSPI_IO1_Msk                     (0x1U << MCU_PAD_XQSPI_IO1_Pos)
#define MCU_PAD_XQSPI_IO1                         MCU_PAD_XQSPI_IO1_Msk

#define MCU_PAD_XQSPI_IO2_Pos                     (20U)
#define MCU_PAD_XQSPI_IO2_Len                     (1U)
#define MCU_PAD_XQSPI_IO2_Msk                     (0x1U << MCU_PAD_XQSPI_IO2_Pos)
#define MCU_PAD_XQSPI_IO2                         MCU_PAD_XQSPI_IO2_Msk

#define MCU_PAD_XQSPI_IO3_Pos                     (21U)
#define MCU_PAD_XQSPI_IO3_Len                     (1U)
#define MCU_PAD_XQSPI_IO3_Msk                     (0x1U << MCU_PAD_XQSPI_IO3_Pos)
#define MCU_PAD_XQSPI_IO3                         MCU_PAD_XQSPI_IO3_Msk
/** @} */
...
#endif // __GR553xx_INT_H__

/** @} */ /* End of group GR553xx */
