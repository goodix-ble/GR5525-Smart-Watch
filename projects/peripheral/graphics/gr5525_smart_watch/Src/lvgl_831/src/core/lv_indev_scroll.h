...
#define _lv_indev_scroll_handler(proc) _lv_indev_scroll_handler_opt(proc)
#define _lv_indev_scroll_throw_handler(proc) _lv_indev_scroll_throw_handler_opt(proc)
