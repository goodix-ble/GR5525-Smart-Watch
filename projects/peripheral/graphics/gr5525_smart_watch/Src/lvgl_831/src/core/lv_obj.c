...
__attribute__((section("RAM_CODE"))) static void lv_obj_event(const lv_obj_class_t * class_p, lv_event_t * e);
#else
...
#if LV_GDX_PATCH_REMOVE_BORDER
#else
        bool status = lv_obj_get_style_border_post(obj, LV_PART_MAIN);
