...
lv_coord_t lv_obj_get_self_width_opt(const struct _lv_obj_t * obj);
lv_coord_t lv_obj_get_self_height_opt(const struct _lv_obj_t * obj);
#define lv_obj_get_self_width(obj) lv_obj_get_self_width_opt(obj)
#define lv_obj_get_self_height(obj) lv_obj_get_self_height_opt(obj)
#else
/**
