...
extern lv_coord_t lv_obj_get_style_pad_top(const struct _lv_obj_t * obj, uint32_t part);
extern lv_coord_t lv_obj_get_style_pad_bottom(const struct _lv_obj_t * obj, uint32_t part);
extern lv_coord_t lv_obj_get_style_pad_left(const struct _lv_obj_t * obj, uint32_t part);
extern lv_coord_t lv_obj_get_style_pad_right(const struct _lv_obj_t * obj, uint32_t part);
#else
...
#if LV_GDX_PATCH_STYLE_CACHE_FOR_OBJ
extern lv_color_t lv_obj_get_style_bg_color(const struct _lv_obj_t * obj, uint32_t part);
extern lv_color_t lv_obj_get_style_bg_color_filtered(const struct _lv_obj_t * obj, uint32_t part);
#else
...
#if LV_GDX_PATCH_ENABLE_POOR_BACKGROUND
...
#if LV_GDX_PATCH_STYLE_CACHE_FOR_OBJ
extern lv_coord_t lv_obj_get_style_border_width(const struct _lv_obj_t * obj, uint32_t part);
#else
...
#if LV_GDX_PATCH_DISABLE_COLOR_FILTER_DSC
#else
...
extern lv_base_dir_t g_global_style_base_dir;
static inline lv_base_dir_t lv_obj_get_style_base_dir(const struct _lv_obj_t * obj, uint32_t part)
{
    return g_global_style_base_dir;
}
#else
#if LV_GDX_PATCH_STYLE_CACHE_FOR_OBJ
extern lv_base_dir_t lv_obj_get_style_base_dir(const struct _lv_obj_t * obj, uint32_t part);
#else
static inline lv_base_dir_t lv_obj_get_style_base_dir(const struct _lv_obj_t * obj, uint32_t part)
{
