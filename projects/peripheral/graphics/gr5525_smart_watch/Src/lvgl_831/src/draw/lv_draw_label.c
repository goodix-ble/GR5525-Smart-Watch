...
void lv_draw_label_dsc_init_ignore(lv_draw_label_dsc_t *dsc)
#else
 ...
 */
#if LV_GDX_PATCH_CACHE_LABEL_LINE_INFO && LV_GDX_PATCH_GLYPH_IN_LABEL_DSC && LV_GDX_PATCH_DRAW_FONT_WITH_PALETTE
LV_ATTRIBUTE_FAST_MEM void lv_draw_label_ignore(lv_draw_ctx_t * draw_ctx, const lv_draw_label_dsc_t * dsc,
...
#if LV_GDX_PATCH_CACHE_LABEL_LINE_INFO && LV_GDX_PATCH_GLYPH_IN_LABEL_DSC && LV_GDX_PATCH_DRAW_FONT_WITH_PALETTE
void lv_draw_letter_ignore(lv_draw_ctx_t * draw_ctx, const lv_draw_label_dsc_t * dsc,  const lv_point_t * pos_p,
                    uint32_t letter)
#else
