...
__attribute__((section("RAM_CODE"))) bool _lv_area_intersect(lv_area_t * res_p, const lv_area_t * a1_p, const lv_area_t * a2_p)
{
    //bool union_ok = true;
...
#if LV_ENABLE_GDX_PATCH > 0u
    // TODO: Try to add some policy to handle circle or big-corner rect
    return true;
#else
