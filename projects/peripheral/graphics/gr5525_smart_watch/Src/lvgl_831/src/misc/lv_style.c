 ...
 *  GLOBAL VARIABLES
 **********************/
#if LV_GDX_PATCH_RAM_CACHE > 0u
uint8_t _lv_style_builtin_prop_flag_lookup_table[_LV_STYLE_NUM_BUILT_IN_PROPS] = {
#else
const uint8_t _lv_style_builtin_prop_flag_lookup_table[_LV_STYLE_NUM_BUILT_IN_PROPS] = {
    ...
    [LV_STYLE_TEXT_OPA] =                  0,
    [LV_STYLE_TEXT_FONT] =                 LV_STYLE_PROP_LAYOUT_REFR,
    [LV_STYLE_TEXT_LETTER_SPACE] =         LV_STYLE_PROP_LAYOUT_REFR,
    [LV_STYLE_TEXT_LINE_SPACE] =           LV_STYLE_PROP_LAYOUT_REFR,
    [LV_STYLE_TEXT_DECOR] =                0,
    [LV_STYLE_TEXT_ALIGN] =                LV_STYLE_PROP_LAYOUT_REFR,
#else
...
{
#if LV_GDX_PATCH_RAM_CACHE > 0u
    extern uint8_t _lv_style_builtin_prop_flag_lookup_table[];
#else
